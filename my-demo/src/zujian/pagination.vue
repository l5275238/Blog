  ...
  <div class='all'>
    <div id='left'>
      ...
      <div id='new-book'>
        ...
        <a href="javascript:0" @click="isAdd=!isAdd">新建文集</a>
    ...
    <div id='center'>
      ...
      <a href="javascript:0" id="textList" v-for="item in textList" @click="showText(item)" v-bind:class="{ active2: item.isClick }"><span>{{item.title}}</span>
        <Icon type="gear-b"></Icon>
      </a>
    ...
    <div id='editor'>
      <div class="title"><input v-model="nowText.title"></div>
